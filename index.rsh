...
const [gameOutcome, B_WINS, DRAW, A_WINS] = makeEnum(3);
...
//All possible combination of abcd will produce one of defined outcome
forall(UInt, a =>
    forall(UInt, b => 
        forall(UInt, c =>
            forall(UInt, d =>
...
export const main = Reach.App(() =>{
    ...
    Bob.interact.acceptWager(amt);  //no return
    Bob.pay(amt)
